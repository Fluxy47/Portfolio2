...
function Landing() {
  return (
   ...
   <section className=' flex justify-between pt-[35px]'>
    <h2 className='ml-10 tracking-wider font-bold text-xl'>@CodeByDenis</h2>
    <div className='flex mr-10 justify-evenly  gap-[2em]'>
      {arr.map((item,idx) => (
...
<h1 className='text-[1.8em] lg:text-[2.4em] lg:mb-[5px]'>Freelance</h1>
  <h1 className=' text-[1.8em] lg:text-[2.4em] '>Designer & Developer</h1>
</div>
  </section>
